class World {
    ...
    constructor(game) {
        ...
        this.requestMouseInput = (mode = "held") => {
            return game.requestMouseData(mode);
        };
        this.requestMousePosition = (rel) => {
            if (rel) {
                return game.getCanvasMousePos();
            }
            else {
                return game.getWindowMousePos();
            }
        };
        this.getGame = () => {
            return game;
